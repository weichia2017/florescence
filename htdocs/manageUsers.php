...
<!Doctype html>
  <head>
    ...
    <div class="container mb-5 mt-5">
        <div class="col border border-secondary p-1 rounded-top text-center p-2" style="background-color: #404040; color: white;">
            <span style="font-size:28px;"  class="material-icons">
                supervisor_account
            </span>
            <span style="font-size:28px;"  class="material-icons">
                compare_arrows
            ...
            <span class="headings" style="color:white">
                Manage Stores Assignment
            </span>
        </div>
            
        <div class="col border border-secondary p-4 rounded-bottom white-bg shadow ">
        ...
        for(user in listOfUsers){
            if(listOfUsers[user]['admin'] != '1'){
                ...
                <a href=mailto:${emailAddress}?subject=${emailSubjectToCustomer}&body=${encodeURIComponent(emailSalutationBody+emailBodyToCustomer)}>
                    <span style="font-size:25px; color: rgb(15 98 183)"  class="material-icons float-right">
                        reply
                    </span>
                </a>`;
